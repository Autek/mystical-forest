...
<table>
	...
	<tr>
		<td>Week 1</td>
		<td>Project proposal<br> Basic effects</td>	<!-- marius -->
		<td>Project proposal<br> Basic effects</td>	<!-- alonso -->
		<td>Project proposal<br> Basic effects</td>	<!-- charlie -->
	</tr>
	...
	<tr>
		<td>Week 7</td>
		<td>Particle effects <i>(cont'd)</i><br> Video and report</td>	<!-- marius -->
		<td>Bloom <i>(cont'd)</i><br> Video and report</td>	<!-- alonso -->
		<td>Ambient occlusion <i>(cont'd)</i><br> Video and report</td>	<!-- charlie -->
	</tr>
	<tr style="background-color: #f9f9f9;">
